...
sample_sizes = [500, 2500, 5000, 10000, 20000]  # Size of each sample. Total size = 2 * sample_size [500, 2500, 5000, 10000, 20000, 30000, 40000]
lambda_mix = 0.2 # Proportion of class 1 in the mixture. (1-lambda_mix) will be the proportion of class 0.
reduced = 0
...
if __name__ == "__main__":
    print(f"Higgs experiments")  # Log the start of experiments
    ...
    for n in sample_sizes:
        ...
        output_folder = f'./output_higgs_paper_fixseed_v2/reduced{reduced}_ntot{ntot}_B{B+1}_niter{n_tests}_mix{lambda_mix}'
