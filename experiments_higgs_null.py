...
def main():
    ...
    parser.add_argument('--n', nargs='+', default=[500, 2500, 5000, 10000, 20000] , type=int, help='List of sample sizes')
    #[500, 2500, 5000, 10000, 20000, 30000, 40000]
    parser.add_argument('--mix', default=0 , type=float, help='Proportion of class 1 data in the mixture')
