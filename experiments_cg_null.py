...
def main():
    ...
    parser.add_argument('--rho2', nargs='+', type=float, default=[0.5], help='List of values of rho2.')
    ...
    for rho2 in RHO2:
        ...
        output_folder = of+"/"+str(datetime.now().date())+f'/cg_ntot{ntot}_B{B+1}_niter{n_tests}'
